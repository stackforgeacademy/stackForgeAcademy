  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="April 11, 2026">
      <section className="mb-10">
        ...
        <p>
          Welcome to StackForge Academy. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
        </p>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-2xl mb-4">3. How We Use Your Data</h2>
        <p>
      ...
      <section className="mb-10">
        <h2 className="text-2xl mb-4">5. Your Legal Rights</h2>
        <p>
